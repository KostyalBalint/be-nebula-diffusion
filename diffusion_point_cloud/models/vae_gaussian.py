...
class GaussianVAE(Module):
    ...
    def sample(self, z, num_points, flexibility, truncate_std=None, stream_diffusion=False):
        """
        Args:
        ...
        samples = self.diffusion.sample(num_points, context=z, flexibility=flexibility, stream_diffusion=stream_diffusion)
        return samples
